...
If you only see a tiny gray sentence on the wallpaper, you are on 0.1.0. Current is 0.1.9 — tap the bird for a chat dock like the demo; speech is a bubble above him, not text on the sprite.
